...
startfunc () {
    yad --center --title="yadshot" --text="Welcome to yadshot" --text-align="center" --height=100 --info --buttons-layout="edge" --button="Upload file/image"\!gtk-go-up:1 --button="Upload paste"\!gtk-copy:2 --button="New Screenshot"\!gtk-new:0 --button=gtk-cancel:3
    case $? in
        1)
